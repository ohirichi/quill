  ...
  return (
    <div className="jumbotron">
      ...
      <p className="lead row">
        <a className="col-sm-4 btn btn-primary btn-md" href="#" role="button" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Get a random new prompt">Get New Prompt</a>

        <Link className="col-sm-4 btn btn-primary btn-md" to="#" role="button"  data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Choose a story you've written that you want to continue to develop">Continue a Story</Link>
      </p>
</div>
